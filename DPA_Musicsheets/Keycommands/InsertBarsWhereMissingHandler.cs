...
{
    public class InsertBarsWhereMissingHandler : HotkeyHandler
    {
        private KeySequence _pattern = KeysequenceDefinitions.ALT_B;
        private ICommand_mb _cmd;

        public InsertBarsWhereMissingHandler(ICommand_mb cmd)
        {
            _cmd = cmd;
        }
